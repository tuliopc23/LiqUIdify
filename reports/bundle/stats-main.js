...
var drawChart = (function (exports) {
  ...
  function T$1(n, l, u) {
    "-" == l[0]
      ...
      : (n[l] =
          null == u ? "" : "number" != typeof u || y$1.test(l) ? u : u + "px");
  }
  ...
  function V(u, t, i, r, o, e, f, c, s) {
    ...
    if (null == x) b === k || (c && u.data == k) || (u.data = k);
      ...
      if (
        ((e = e && n.call(u.childNodes)), (b = i.props || p$1), !c && null != e)
      )
  ...
  function x(n) {
    ...
    return (
      (i.c = n),
      u ? (null == i.__ && ((i.__ = true), u.sub(r)), u.props.value) : n.__
    );
  }
  function j() {
    for (var n; (n = f.shift()); )
              ...
              return u$1(
                "div",
                {
                  ...
                  children: [
                    ...
                    u$1("label", { htmlFor: id, children: LABELS[sizeProp] }),
                  ],
                },
                sizeProp,
              );
    ...
    const content = T(() => {
      ...
      return u$1(k$1, {
        children: [
              ...
              return u$1(
                "div",
                {
                  children: [
                    LABELS[sizeProp],
                    ": ",
                    bytesExports.format(getModuleSize(node.data, sizeProp)),
                  ],
                },
                sizeProp,
              );
          ...
          u$1("br", {}),
          u$1("small", {
            children: data.options.sourcemap ? SOURCEMAP_RENDERED : RENDRED,
          }),
          (data.options.gzip || data.options.brotli) &&
            u$1(k$1, {
              children: [u$1("br", {}), u$1("small", { children: COMPRESSED })],
            }),
        ],
      });
    }, [
