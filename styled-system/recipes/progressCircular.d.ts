...
export type ProgressCircularVariantProps = {
	[key in keyof ProgressCircularVariant]?:
		| ConditionalValue<ProgressCircularVariant[key]>
		| undefined;
};
...
export interface ProgressCircularRecipe {
	...
	splitVariantProps<Props extends ProgressCircularVariantProps>(
		props: Props,
	): [
		ProgressCircularVariantProps,
		Pretty<DistributiveOmit<Props, keyof ProgressCircularVariantProps>>,
	];
	getVariantProps: (
		props?: ProgressCircularVariantProps,
	) => ProgressCircularVariantProps;
}
