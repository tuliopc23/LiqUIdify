...
export type AngleSliderVariantProps = {
  [key in keyof AngleSliderVariant]?: ConditionalValue<AngleSliderVariant[key]> | undefined
}
...
export interface AngleSliderRecipe {
  ...
  splitVariantProps<Props extends AngleSliderVariantProps>(props: Props): [AngleSliderVariantProps, Pretty<DistributiveOmit<Props, keyof AngleSliderVariantProps>>]
