...
export type FloatingPanelVariantProps = {
	[key in keyof FloatingPanelVariant]?:
		| ConditionalValue<FloatingPanelVariant[key]>
		| undefined;
};
...
export interface FloatingPanelRecipe {
	...
	splitVariantProps<Props extends FloatingPanelVariantProps>(
		props: Props,
	): [
		FloatingPanelVariantProps,
		Pretty<DistributiveOmit<Props, keyof FloatingPanelVariantProps>>,
	];
	getVariantProps: (
		props?: FloatingPanelVariantProps,
	) => FloatingPanelVariantProps;
}
