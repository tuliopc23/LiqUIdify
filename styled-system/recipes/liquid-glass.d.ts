...
export type LiquidGlassVariantProps = {
  [key in keyof LiquidGlassVariant]?: ConditionalValue<LiquidGlassVariant[key]> | undefined
}
...
export interface LiquidGlassRecipe {
  ...
  splitVariantProps<Props extends LiquidGlassVariantProps>(props: Props): [LiquidGlassVariantProps, Pretty<DistributiveOmit<Props, keyof LiquidGlassVariantProps>>]
