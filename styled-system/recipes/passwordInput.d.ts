...
interface PasswordInputVariant {
...
export type PasswordInputVariantProps = {
  [key in keyof PasswordInputVariant]?: ConditionalValue<PasswordInputVariant[key]> | undefined
}
...
export interface PasswordInputRecipe {
  ...
  splitVariantProps<Props extends PasswordInputVariantProps>(props: Props): [PasswordInputVariantProps, Pretty<DistributiveOmit<Props, keyof PasswordInputVariantProps>>]
  getVariantProps: (props?: PasswordInputVariantProps) => PasswordInputVariantProps
}
