  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'liquid-glass': '0 6px 6px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 0, 0, 0.1)',
        
        // Enhanced glass shadow
        'liquid-enhanced': '0 0 0 2px rgba(255, 255, 255, 0.6), 0 16px 32px rgba(0, 0, 0, 0.12)',
        
        // Specular highlights (the liquid effect)
        'liquid-specular': 'inset 1px 1px 0 rgba(255, 255, 255, 0.75), inset 0 0 5px rgba(255, 255, 255, 0.75)',
        ...
        'liquid-button': '0 4px 8px rgba(0, 0, 0, 0.15), 0 0 12px rgba(0, 0, 0, 0.08)',
        'liquid-card': '0 8px 16px rgba(0, 0, 0, 0.12), 0 0 24px rgba(0, 0, 0, 0.06)',
      ...
      filter: {
        ...
        'liquid-shine': 'blur(1px) drop-shadow(10px 4px 6px black) brightness(115%)',
      },
