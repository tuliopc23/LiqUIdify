    ...
    extend: {
      ...
      colors: {
        ...
        background: {
          "apple-light": "#f0f9ff",
          "apple-dark": "#0f172a", 
          "gradient-light": "radial-gradient(80rem 60rem at 20% 20%, rgba(162, 210, 255, 0.3), transparent 60%), radial-gradient(80rem 60rem at 80% 30%, rgba(255, 183, 248, 0.28), transparent 60%), linear-gradient(135deg, #c9e7ff 0%, #d9d0ff 45%, #ffc9dc 100%)",
        },
      },
      ...
      boxShadow: {
        ...
        "liquid-main": "var(--lg-shadow-main, 0 6px 6px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 0, 0, 0.1))",
        
        // Shine effect shadow (exact from reference) 
        "liquid-shine": "var(--lg-shine-shadow, inset -10px -8px 0px -11px rgba(255, 255, 255, 1), inset 0px -9px 0px -8px rgba(255, 255, 255, 1))",
        
        // Elevated glass shadow
        "liquid-elevated": "0 12px 24px rgba(0, 0, 0, 0.15), 0 0 32px rgba(0, 0, 0, 0.08)",
        
        // Ghost button shadows
        "liquid-ghost-light": "0 4px 10px rgba(0, 0, 0, 0.08)",
        "liquid-ghost-dark": "0 12px 20px rgba(0, 0, 0, 0.24), 0 2px 4px rgba(0, 0, 0, 0.14)",
        
        // Modal shadow
        "liquid-modal": "0 24px 48px rgba(0, 0, 0, 0.2), 0 0 40px rgba(0, 0, 0, 0.1)",
        
        // Focus shadow  
        "liquid-focus": "var(--lg-shadow-main, 0 6px 6px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 0, 0, 0.1)), 0 0 0 4px rgba(0, 122, 255, 0.2)",
      },
