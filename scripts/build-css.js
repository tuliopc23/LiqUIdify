...
async function buildCSS() {
    ...
    try {
        ...
        result.bundles.forEach(bundle => {
            ...
            console.log(`${bundle.name.padEnd(12)} │ ${sizeKB.padStart(8)}KB │ ${gzipKB.padStart(8)}KB gzip │ ${critical}`);
        });
        ...
        if (validation.passed) {
            ...
            validation.violations.forEach(violation => {
                ...
                console.log(`${icon} ${violation.bundle}: ${actualKB}KB > ${limitKB}KB limit`);
            });
        }
