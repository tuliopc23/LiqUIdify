...
export default defineConfig({
    ...
    extend: {
      ...
      slotRecipes: {
        ...
        menu: {
          className: "menu",
          jsx: ["Menu"],
          slots: ["trigger", "positioner", "content", "item", "itemText", "separator"],
          base: {
            trigger: {
              position: "relative",
              overflow: "hidden",
        ...
        popover: {
          className: "popover",
          jsx: ["Popover"],
          slots: ["trigger", "positioner", "content", "title", "description", "closeTrigger"],
          base: {
            trigger: {
              position: "relative",
              overflow: "hidden",
        ...
        combobox: {
          className: "combobox",
          jsx: ["Combobox"],
          slots: ["root", "trigger", "input", "positioner", "content", "item", "itemText"],
          base: {
            root: {
              position: "relative",
              display: "inline-flex",
        ...
        fileUpload: {
          ...
          jsx: ["FileUpload"],
          slots: ["root", "dropzone", "trigger", "itemGroup", "item", "itemName", "itemSizeText"],
          base: {
            root: {
              position: "relative",
              display: "flex",
        ...
        carousel: {
          ...
          base: {
            ...
            itemGroup: {
              display: "flex",
              transition: "transform token(durations.glass.flow) token(easings.glass.flow)",
            },
            item: {
              flex: "0 0 100%",
              minWidth: 0,
  ...
  globalCss: {
    ...
    ".liquid-wobble-active": {
      animation: "liquidJiggle token(durations.glass.bounce) token(easings.glass.bounce)",
    },
    ...
    ".liquid-flow": {
      animation: "liquidFlow token(durations.glass.flow) token(easings.glass.flow)",
    },
