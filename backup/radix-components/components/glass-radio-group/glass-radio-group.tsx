...
const radioItemVariants = cva({
 base: "group flex cursor-pointer items-center gap-2 rounded-xl p-2 transition-all duration-200 hover:/5 focus:/10 focus:outline-none data-[state=checked]:/10 data-[state=checked]:shadow-lg border border-blue-500/20 backdrop-blur-md ",
 variants: {
 size: {
...
const radioIndicatorVariants = cva({
 base: "relative h-5 w-5 rounded-full border-2 border-blue-300/20 group-data-[state=checked]:border-blue-500 group-data-[state=checked]:bg-gradient-to-br group-data-[state=checked]:from-liquid-primary/20 group-data-[state=checked]:to-liquid-primary-light/20 backdrop-blur-sm transition-all duration-200 group-hover:border-blue-300/40 group-focus:border-blue-500",
 variants: {},
});
