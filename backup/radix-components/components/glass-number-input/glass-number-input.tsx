...
const inputVariants = cva({
  ...
  variants: {
    ...
    error: {
      true: "border-blue-500/50 focus:border-blue-500",
      false: "border-[var(--)] focus:border-[var(--)]",
    },
  },
  defaultVariants: {
    size: "md",
...
const buttonVariants = cva({
  base: cn(
    ...
    "rounded-lg border-blue-500/30",
    "transition-all duration-200 hover:border-blue-500/50 focus:border-blue-500/60",
      ...
      >
        ...
        {label && (
          <label
            ...
            htmlFor={props.id}
            className={cn(
              "mb-2 block font-medium text-blue-900",
              size === "sm" && "text-sm",
              size === "lg" && "text-lg"
            )}
          >
            {label}
            {props.required && <span className="ml-1 text-blue-600">*</span>}
          </label>
        )}
        ...
        <div className="relative">
          <input
            ...
            aria-describedby={cn(description && descriptionId, helperText && helperTextId)}
            role="spinbutton"
            aria-valuemin={min}
            aria-valuemax={max}
        ...
        {helperText && (
          <p
            id={helperTextId}
            className={cn("mt-1.5 text-xs", error ? "text-blue-600" : "text-blue-500")}
          >
            {helperText}
          </p>
        )}
