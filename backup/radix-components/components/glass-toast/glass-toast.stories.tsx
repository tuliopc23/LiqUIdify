...
const ActionToastDemo = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {undone && <p className="text-blue-900 text-sm">Item restored!</p>}
    </div>
  );
};
...
const MultipleToastsDemo = () => {
  ...
  return (
    <button
      ...
      className="rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-2 text-blue-900 hover:from-blue-600 hover:to-purple-600"
    >
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4">
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          className="rounded-lg bg-blue-500 px-4 py-2 text-blue-900 hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
        >
