        ...
        <div ref={ref} className={cn("", "relative w-full", className)} {...props}>
          {showValue && (
            <div className="mb-3 flex items-center justify-between">
              <span className="text-blue-900/70 text-sm">Value</span>

              <span className="font-medium text-blue-900 text-sm">{currentValue}</span>
            </div>
          )}
          ...
          <div className="mt-2 flex items-center justify-between text-blue-900/70 text-xs">
            <span>{min}</span>
