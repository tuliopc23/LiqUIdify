...
const GlassTextarea = forwardRef<HTMLTextAreaElement, GlassTextareaProps>(
  (
    ...
    const textareaClasses = cn(
      ...
      SIZE_CLASSES[size],
      error
        ? "border-blue-500/50 focus:border-blue-500 focus:ring-red-500/20"
        : "border-/30 focus:border-text-blue-600 focus:ring-text-blue-600/20"
    );
    ...
    return (
      ...
      >
          ...
          {showCharacterCount && (
            <div
              className={cn(
                ...
                isOverLimit ? "text-blue-600" : "text-blue-500/70"
              )}
            >
        ...
        {helperText && (
          <p
            id={helperTextId}
            className={cn("mt-1.5 text-xs", error ? "text-blue-600" : "text-blue-500/80")}
          >
            {helperText}
          </p>
        )}
