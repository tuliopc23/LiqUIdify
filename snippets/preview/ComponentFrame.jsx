...
export default function ComponentFrame({ title, intro, code, children, variant = "elevated" }) {
  ...
  const variantClasses = {
    ...
    elevated:
      "bg-white/80 dark:bg-black/40 border-gray-200/30 dark:border-gray-700/30 shadow-xl backdrop-blur-xl",
  ...
  return (
    <ProviderWrapper>
      <div
        className={`relative rounded-xl overflow-hidden border transition-all duration-300 ${variantClasses[variant]}`}
      >
