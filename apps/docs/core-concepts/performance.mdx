...
|-------------------|----------|---------|-------------|
| Core System       | 12kb     | 4.2kb   | ✅          |
| Form Controls     | 28kb     | 9.1kb   | ✅          |
| Layout            | 15kb     | 5.3kb   | ✅          |
| Navigation        | 22kb     | 7.8kb   | ✅          |
| **Full Library**  | **89kb** | **31kb**| ✅          |
...
function GlassCard() {
  ...
  return (
    <Card className={reducedMotion ? "simple" : "liquid-glass"}>
      Content
    </Card>
  );
}
...
// ❌ Avoid - Complex objects cause unnecessary re-renders
