...
└── bundles/
    ├── core.d.ts       # Core components bundle
    ├── forms.d.ts      # Form components bundle
    ├── navigation.d.ts # Navigation components
    └── feedback.d.ts   # Feedback components
```
...
├── glass-button.tsx         # Main component
├── glass-button.test.tsx    # Unit tests
...
├── useLiquidGlass.ts     # Glass effects configuration
├── useHapticFeedback.ts  # Haptic feedback
├── useMediaQuery.ts      # Responsive breakpoints
├── useDebounce.ts        # Input debouncing
└── useSsrSafe.ts        # SSR compatibility
```
...
- [Onboarding](./onboarding): Creating components
