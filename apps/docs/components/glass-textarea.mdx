...
export default function Demo() {
  ...
  const [feedback, setFeedback] = useState('This component looks amazing! The liquid glass effects really make it stand out.')
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <div className="p-4 rounded-lg bg-white/5 border border-white/10">
        <h3 className="font-medium text-white mb-2">Character Counts:</h3>
...
<div>
  ...
  <div className="mt-2 text-sm text-white/60">
    Words: {wordCount} | Estimated reading time: {Math.ceil(wordCount / 200)} min
  </div>
</div>
```
