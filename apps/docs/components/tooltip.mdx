...
function TooltipTiming() {
  return (
    <div className="flex gap-4">
      ...
      <Tooltip content="Stays open for 3 seconds" closeDelay={3000}>
...
function DisabledTooltip() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Tooltip content="This tooltip can be disabled" isDisabled={disabled}>
        <Button>{disabled ? "Tooltip Disabled" : "Tooltip Enabled"}</Button>
      </Tooltip>
    </div>
  );
}
...
function TooltipArrows() {
  return (
    <div className="flex gap-4">
      ...
      <Tooltip content="Custom arrow size" showArrow={true} arrowSize={12}>
...
>
  <Button aria-describedby="tooltip-id">Button with tooltip</Button>
</Tooltip>
```
...
```tsx
<Tooltip content="Help text" trigger={isMobile ? "click" : "hover"}>
  <HelpIcon />
</Tooltip>
```
