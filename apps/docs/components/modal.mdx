...
import { GlassButton, GlassCheckbox, GlassInput, GlassModal } from "liquidify";
...
<Preview
  title="Basic Usage"
  code={`import { GlassButton, GlassModal } from "liquidify";
...
<GlassButton onClick={() => setIsOpen(true)}>Open Modal</GlassButton>
      ...
      >
        <div className="space-y-4">
          ...
          <p>
            The backdrop creates a beautiful blur effect while maintaining
            readability.
          </p>
...
key: "xl",
label: "Extra Large",
description: "Maximum size for detailed forms",
},
{
key: "full",
label: "Full Screen",
description: "Full screen modal for immersive experiences",
},
];
      ...
      {sizes.map((size) => (
        ...
        >
          <div className="space-y-4">
            ...
            <p>
              This modal demonstrates the {size.key} size variant with
...
<Preview
  title="Form Modal"
  code={`import { GlassButton, GlassInput, GlassModal } from "liquidify";
import { useState } from "react";
