    ...
    <div>
      ...
      >
        <div className="space-y-4">
          <p>This is a basic modal with liquid glass effects.</p>
          <p>The backdrop creates a beautiful blur effect while maintaining readability.</p>
...
export default function Demo() {
  ...
  const sizes = [
    { key: 'sm', label: 'Small', description: 'Compact modal for simple confirmations' },
    ...
    { key: 'xl', label: 'Extra Large', description: 'Maximum size for detailed forms' },
    { key: 'full', label: 'Full Screen', description: 'Full screen modal for immersive experiences' }
  ]
      ...
      <div className="flex gap-2 flex-wrap">
        {sizes.map((size) => (
          <GlassButton 
            key={size.key}
            size="sm"
            onClick={() => setActiveModal(size.key)}
          >
            {size.label}
          </GlassButton>
        ))}
      ...
      {sizes.map((size) => (
        ...
        >
          <div className="space-y-4">
            ...
            <p>This modal demonstrates the {size.key} size variant with appropriate spacing and proportions.</p>
            
            <div className="flex justify-end gap-3 mt-6">
              <GlassButton variant="ghost" onClick={() => setActiveModal(null)}>
                Close
              </GlassButton>
            </div>
          </div>
...
```tsx live
import { useState } from 'react'
import { GlassModal, GlassButton, GlassInput } from '@liquidify/components'
...
```tsx
import { GlassModal, GlassButton, GlassInput, GlassCheckbox } from '@liquidify/components'
