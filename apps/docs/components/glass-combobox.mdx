  ...
  return (
    <div className="space-y-6 max-w-md mx-auto">
      ...
      <div className="p-4 rounded-lg bg-liquid-bg/5 border border-liquid-highlight/10">
        ...
        <p className="text-liquid-text-inverse/70 text-sm">
  ...
  return (
    <div
      className={cn(
        ...
        isSelected && "bg-liquid-accent/20",
        isHighlighted && "bg-liquid-bg/10",
      )}
    >
      {option.icon}
      <div>
        ...
        {option.description && (
          <div className="text-sm text-liquid-text-inverse/60">{option.description}</div>
        )}
      </div>
    </div>
  );
