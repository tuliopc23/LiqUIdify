...
import { LineChart, BarChart, DonutChart } from '@liquidify/components'
...
export default function Demo() {
  ...
  const barData = [
    { label: 'Q1', value: 2400, color: '#3B82F6' },
    { label: 'Q2', value: 1398, color: '#10B981' },
    { label: 'Q3', value: 9800, color: '#F59E0B' },
    { label: 'Q4', value: 3908, color: '#EF4444' }
  ]
