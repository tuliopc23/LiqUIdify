...
import { GlassButton, GlassPortal } from "@liquidify/react";
  ...
  return (
    <GlassPortal>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div
          className="absolute inset-0 bg-liquid-bg/50 backdrop-blur-sm"
          onClick={onClose}
        />
        <div className="relative bg-liquid-bg/10 backdrop-blur-xl rounded-xl p-6">
          {children}
        </div>
      </div>
    </GlassPortal>
