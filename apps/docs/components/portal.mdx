...
import { GlassPortal, GlassButton } from '@liquidify/components'

export default function Demo() {
  const [showPortal, setShowPortal] = useState(false)
  
  return (
    <div style={{position:'relative', padding:20, border:'2px dashed rgba(255,255,255,0.3)', borderRadius:8}}>
        ...
        <GlassPortal>
          <div style={{
            ...
            <p style={{margin:'0 0 12px 0', fontSize:'0.875rem', opacity:0.9}}>
              This content is rendered outside the parent container using a portal!
            </p>
...
export default function Demo() {
  ...
  return (
    <div style={{display:'flex', gap:20}}>
      <div style={{flex:1, padding:16, border:'1px solid rgba(255,255,255,0.3)', borderRadius:8}}>
          ...
          >
            ...
            >
              ...
              <p style={{margin:'0 0 20px 0', opacity:0.8}}>
                ...
                regardless of the parent component's z-index or overflow settings.
              </p>
      ...
      {portals.map(portal => (
        <GlassPortal key={portal.id}>
          <div style={{
            ...
            <div style={{fontSize:'0.875rem', marginBottom:8}}>Portal #{portal.id}</div>
...
const ContextMenu = ({ x, y, items, onClose }) => (
  <GlassPortal>
    <div 
      className="fixed z-50 glass-context-menu"
      style={{ left: x, top: y }}
    >
      {items.map(item => (
        <button 
...
const OptimizedPortal = React.memo(({ children, container }) => {
  return (
    <GlassPortal container={container}>
      {children}
    </GlassPortal>
  )
})
