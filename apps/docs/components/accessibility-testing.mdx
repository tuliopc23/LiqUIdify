...
This guide explains how to use Liquidify's built-in accessibility testing utilities to ensure WCAG 2.1 AA compliance across your application. Our automated testing tools help catch common accessibility issues early in development.

### Key Features

- **Automated Testing**: Built-in Jest and Playwright integration
- **Real-time Validation**: Development-time accessibility checks
- **Visual Reports**: Accessibility score badges and reports
