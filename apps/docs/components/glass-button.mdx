...
<table className="props-table">
  ...
  <tbody>
    <tr>
      ...
      <td><code className="prop-type">"primary" | "secondary" | "success" | "danger"</code></td>
    ...
    <tr>
      <td><code className="prop-name">onClick</code></td>
      <td><code className="prop-type">(event: MouseEvent) => void</code></td>
...
<div className="glass-demo">
  ...
  <p>This component showcases our signature glass effect with backdrop blur, subtle transparency, and smooth animations that create depth and visual hierarchy.</p>
...
<Callout type="info">
Use glass buttons on backgrounds with sufficient contrast to maintain readability and visual hierarchy.
</Callout>

<Callout type="warning">
Avoid using multiple glass elements in close proximity as it can reduce visual clarity.
</Callout>
