...
export default function Demo() {
  return (
    <div className="flex items-center gap-4 flex-wrap">
      <GlassButton leftIcon={<Heart className="w-4 h-4" />}>
        Like
      </GlassButton>
...
function CallToAction({ onGetStarted, onLearnMore }) {
  return (
    <div className="text-center space-y-4">
      ...
      <p className="text-gray-600 mb-6">Join thousands of users already using our platform.</p>
    ...
    <div className="text-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
      <div className="space-y-4">
        <div className="text-gray-600">
          {isUploading ? `Uploading... ${progress}%` : 'Drag files here or click to browse'}
        </div>
