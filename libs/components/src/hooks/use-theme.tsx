...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    // Add new theme classes (liquid-glass system uses theme-* classes)
    ...
    // All liquid glass colors are now handled by CSS in liquid-glass-system.css
    ...
    console.log(`🎨 Theme applied: ${theme}`, {
      ...
      note: "Liquid glass colors handled by CSS variables in liquid-glass-system.css",
    });
  }, [theme]);
