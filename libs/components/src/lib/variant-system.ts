...
export const glassVariants = createVariants({ base: 'relative overflow-hidden transition-all duration-300 ease-out' }
  variants: { variant: {
    ...
    size: { xs: 'text-xs px-2 py-1 min-h-[28px] rounded-sm' }
...
export const buttonVariants = createVariants({ base: 'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50' }
  variants: { variant: {
      ...
      'glass-primary':
        'glass-effect bg-primary/10 text-primary border-primary/20 hover:bg-primary/20',
      'glass-secondary':
        'glass-effect bg-secondary/10 text-secondary border-secondary/20 hover:bg-secondary/20',
    },
...
export const cardVariants = createVariants({ base: 'rounded-lg border bg-card text-card-foreground shadow-sm' }
  variants: { variant: {
      default: 'glass-effect' }
      elevated: 'glass-effect-elevated shadow-medium',
      floating:
        'backdrop-blur-heavy bg-glass-light-floating border-border-glass-light-medium shadow-light',
...
export const inputVariants = createVariants({ base: 'flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50' }
  variants: { variant: {
      default: 'glass-effect' }
      outline: 'border-2 bg-transparent',
...
export const animationStates = { idle: 'scale-100 opacity-100' }
