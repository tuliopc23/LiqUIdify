...
describe('glass-card-refactored exports', () => {
  ...
  describe('Accessibility compliance', () => {
    ...
    it('should provide appropriate ARIA attributes for selectable cards', () => {
      render(<GlassCard selectable selected={false}>Selectable card</GlassCard>);
      const card = screen.getByTestId('glass-card');
  ...
  describe('State management', () => {
    ...
    it('should manage selection state when controlled', async () => {
      ...
      const { rerender } = render(
        <GlassCard selectable selected={selectedState} onCardSelect={setSelected}>
          Selectable card
        </GlassCard>
      );
      ...
      expect(screen.getByTestId('glass-card')).toHaveAttribute('aria-pressed', 'true');
    });
  });
});