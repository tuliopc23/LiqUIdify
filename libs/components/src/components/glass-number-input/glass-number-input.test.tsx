...
describe("GlassNumberInput", () => {
  ...
  it("disables increment when at max value", () => {
    render(<GlassNumberInput label="Max Test" defaultValue={10} max={10} />);
  ...
  it("disables decrement when at min value", () => {
    render(<GlassNumberInput label="Min Test" defaultValue={0} min={0} />);
  ...
  it("can be disabled", () => {
    render(<GlassNumberInput label="Disabled" disabled={true} />);
  ...
  it("can hide controls", () => {
    render(<GlassNumberInput label="No Controls" showControls={false} />);
  ...
  it("handles required field", () => {
    render(<GlassNumberInput label="Required" required={true} />);
