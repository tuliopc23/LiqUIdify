...
import { LiquidToast, ToastProvider, useToast, toast } from './liquid-toast';
...
const meta: Meta<typeof LiquidToast> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A toast notification system with Apple HIG liquid glass design, queue management, and multiple positioning options.',
      },
    },
  },
  decorators: [
  ...
  return (
    <div className="space-y-4">
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">Click the buttons below to trigger different types of toasts</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <LiquidButton
            onClick={() => showToast({
              ...
              duration: 10000,
              action: (
                <LiquidButton size="sm" variant="ghost" className="text-blue-200 hover:text-blue-100">
                  Update
                </LiquidButton>
              ),
            })}
          ...
          <LiquidButton
            onClick={() => showToast({
              ...
              variant: "success",
              action: (
                <LiquidButton size="sm" variant="ghost" className="text-green-200 hover:text-green-100">
                  View
                </LiquidButton>
              ),
            })}
          ...
          <LiquidButton
            onClick={() => showToast({
              ...
              action: (
                <LiquidButton size="sm" variant="ghost" className="text-red-200 hover:text-red-100">
                  Retry
                </LiquidButton>
              ),
            })}
          ...
          <LiquidButton
            onClick={() => showToast({
              ...
              variant: "warning",
              action: (
                <LiquidButton size="sm" variant="ghost" className="text-yellow-200 hover:text-yellow-100">
                  Manage
                </LiquidButton>
              ),
            })}
  ...
  render: () => {
    ...
    const showMultipleToasts = () => {
      const toasts = [
        ...
        { title: "Fifth Toast", description: "One more for good measure", variant: "default" as const },
      ];
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <LiquidButton onClick={showMultipleToasts}>
  ...
  <ToastProvider position={position}>
    <div className="space-y-4">
      ...
      <div className="flex gap-2 justify-center">
        <LiquidButton
          onClick={() => toast.success(`Success from ${position}!`)}
          size="sm"
        >
          Success
        </LiquidButton>
...
export const Interactive: Story = {
  render: () => {
    ...
    const [description, setDescription] = useState('This toast can be customized using the controls below.');
