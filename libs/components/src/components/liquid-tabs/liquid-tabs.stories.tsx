...
const meta: Meta<typeof LiquidTabs> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Animated tab component with Apple HIG liquid glass design, supporting multiple variants and orientations.',
      },
    },
  },
  argTypes: {
...
const simpleTabs = [
  { value: 'tab1', label: 'Tab One', content: <div className="text-white">Content for Tab One</div> },
  { value: 'tab2', label: 'Tab Two', content: <div className="text-white">Content for Tab Two</div> },
  { value: 'tab3', label: 'Tab Three', content: <div className="text-white">Content for Tab Three</div> },
];
...
export const WithBadges: Story = {
  args: {
    variant: 'card',
    tabs: [
      { value: 'inbox', label: 'Inbox', badge: '12', content: <div className="text-white">Inbox content with 12 new messages</div> },
      { value: 'drafts', label: 'Drafts', badge: '3', content: <div className="text-white">Draft messages</div> },
      { value: 'sent', label: 'Sent', content: <div className="text-white">Sent messages</div> },
      { value: 'trash', label: 'Trash', badge: '1', content: <div className="text-white">Deleted messages</div> },
    ],
    defaultValue: 'inbox',
  },
};
...
export const WithDisabledTab: Story = {
  args: {
    tabs: [
      { value: 'available', label: 'Available', content: <div className="text-white">This tab is available</div> },
      { value: 'disabled', label: 'Disabled', disabled: true, content: <div className="text-white">This content won't show</div> },
      { value: 'another', label: 'Another', content: <div className="text-white">Another available tab</div> },
    ],
...
export const LongLabels: Story = {
  args: {
    variant: 'card',
    tabs: [
      { value: 'very-long', label: 'Very Long Tab Label', content: <div className="text-white">Content for very long tab</div> },
      { value: 'extremely', label: 'Extremely Long Tab Label That Might Wrap', content: <div className="text-white">Content for extremely long tab</div> },
      { value: 'short', label: 'Short', content: <div className="text-white">Content for short tab</div> },
    ],
      ...
      { 
        ...
        content: (
          <div className="space-y-4">
            <DashboardContent />
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20">
              <p className="text-white/80">Selected tab: <strong>{selectedTab}</strong></p>
            </div>
          </div>
        )
      },
