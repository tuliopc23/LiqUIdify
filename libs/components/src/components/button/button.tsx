...
>(props: ButtonProps<C>, ref: React.Ref<any>) {
	...
	// Enhanced liquid animations with magnetic hover (already respects reduced motion internally)
	...
	const composedHandlers = {
		...
		onMouseDown: composeHandlers(
			consumerMouseDown,
			glassMicro.interactions.onPressStart,
		),
		onMouseUp: composeHandlers(
			consumerMouseUp,
			glassMicro.interactions.onPressEnd,
		),
