...
const meta: Meta<typeof LiquidPopover> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A popover component with smart positioning, modal support, and Apple HIG liquid glass design.",
      },
    },
  },
  argTypes: {
...
const PopoverWrapper = ({ children, triggerLabel = "Open Popover", ...props }: any) => {
  ...
  return (
    <LiquidPopover
      ...
      trigger={<LiquidButton onClick={() => setOpen(!open)}>{triggerLabel}</LiquidButton>}
      {...props}
    >
      {children}
    </LiquidPopover>
...
export const MenuVariant: Story = {
  render: (args) => (
    <PopoverWrapper {...args} triggerLabel="Actions" variant="menu">
      <LiquidPopoverMenuItem icon={<EditIcon />}>Edit</LiquidPopoverMenuItem>
      <LiquidPopoverMenuItem icon={<ShareIcon />}>Share</LiquidPopoverMenuItem>
    ...
    <div className="space-y-4">
      ...
      >
        <PopoverWrapper variant="menu" triggerLabel="Right-click me" side="bottom" align="start">
          <LiquidPopoverMenuItem icon={<EditIcon />}>Edit Item</LiquidPopoverMenuItem>
          <LiquidPopoverMenuItem icon={<ShareIcon />}>Share Item</LiquidPopoverMenuItem>
          <hr className="border-white/10 my-1" />
          <LiquidPopoverMenuItem>Properties</LiquidPopoverMenuItem>
          <LiquidPopoverMenuItem icon={<DeleteIcon />} destructive>
            Delete Item
          </LiquidPopoverMenuItem>
        </PopoverWrapper>
