...
const meta: Meta<typeof LiquidSidebar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A collapsible sidebar with liquid glass design, supporting nested navigation, badges, and keyboard interaction.',
      },
    },
  },
  argTypes: {
...
const DocumentIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
    ...
    <path fillRule="evenodd" d="M2 7.816V15a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.816A2 2 0 0 1 16 6H4a2 2 0 0 1-2 1.816ZM6 10a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1Zm1 3a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2H7Z" clipRule="evenodd"/>
  </svg>
);
      ...
      <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
        {Array.from({ length: 6 }, (_, i) => (
          <div key={i} style={{ 
            ...
            <p style={{ opacity: 0.7, fontSize: '0.9rem' }}>Sample content to demonstrate the layout with the sidebar.</p>
          </div>
        ))}
      </div>
    </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ opacity: 0.8 }}>
              Try interacting with the sidebar navigation, collapsing/expanding it, and clicking on items.
            </p>
          </div>
