...
const meta: Meta<typeof LiquidNavbar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A responsive navigation bar with Apple HIG liquid glass design, mobile menu support, and hide-on-scroll functionality.",
      },
    },
  },
  argTypes: {
...
const InteractiveWrapper = ({ children }: { children: React.ReactNode }) => {
  return (
    <div
      style={{ height: "200vh", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" }}
    >
      <div style={{ padding: "100px 20px", color: "white" }}>
        <h1 style={{ fontSize: "2rem", marginBottom: "1rem" }}>
          Scroll down to test hide-on-scroll behavior
        </h1>
        <p style={{ marginBottom: "2rem" }}>
          This page has extra height to demonstrate scroll behavior.
        </p>
        {children}
