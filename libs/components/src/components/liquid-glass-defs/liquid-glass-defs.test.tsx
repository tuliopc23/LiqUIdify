...
describe("LiquidGlassDefs", () => {
  ...
  describe("SVG Filters", () => {
    ...
    it("renders liquid glass displacement filter", () => {
      const { container } = render(<LiquidGlassDefs />);
      const displacementFilter = container.querySelector("#liquid-glass-displacement");
      
      expect(displacementFilter).toBeInTheDocument();
      
      // Check for displacement map
      const displacementMap = displacementFilter?.querySelector("feDisplacementMap");
    ...
    it("renders liquid glass morphology filter", () => {
      const { container } = render(<LiquidGlassDefs />);
      const morphologyFilter = container.querySelector("#liquid-glass-morphology");
    ...
    it("renders liquid glass holographic filter", () => {
      const { container } = render(<LiquidGlassDefs />);
      const holographicFilter = container.querySelector("#liquid-glass-holographic");
    ...
    it("renders liquid glass iridescent filter", () => {
      const { container } = render(<LiquidGlassDefs />);
      const iridescentFilter = container.querySelector("#liquid-glass-iridescent");
      
      expect(iridescentFilter).toBeInTheDocument();
      
      // Check for specular lighting
      const specularLighting = iridescentFilter?.querySelector("feSpecularLighting");
  ...
  describe("Masks", () => {
    ...
    it("renders liquid glass circular mask", () => {
      const { container } = render(<LiquidGlassDefs />);
      const circularMask = container.querySelector("#liquid-glass-mask-circular");
  ...
  describe("Performance Optimizations", () => {
    it("filters have appropriate color-interpolation-filters", () => {
      ...
      filters.forEach((filter) => {
        ...
        const filterOperations = filter.querySelectorAll("feGaussianBlur, feColorMatrix");
