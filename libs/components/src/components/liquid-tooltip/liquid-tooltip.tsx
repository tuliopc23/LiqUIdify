...
interface LiquidTooltipProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof liquidTooltipVariants> {
...
export const LiquidTooltip = React.forwardRef<HTMLDivElement, LiquidTooltipProps>(
  ({
    ...
    const calculatePosition = useCallback((preferredSide: TooltipSide = side, preferredAlign: TooltipAlign = align): Position => {
