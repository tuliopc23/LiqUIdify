...
describe("GlassTextarea", () => {
  ...
  it("handles value changes", () => {
    ...
    render(<GlassTextarea label="Text" onChange={handleChange} />);
  ...
  it("enforces max length", () => {
    const handleChange = jest.fn();
    render(
      <GlassTextarea label="Limited" maxLength={5} onChange={handleChange} />,
    );
  ...
  it("allows typing within max length", () => {
    const handleChange = jest.fn();
    render(
      <GlassTextarea label="Limited" maxLength={10} onChange={handleChange} />,
    );
  ...
  it("handles keyboard events correctly", () => {
    ...
    render(<GlassTextarea label="Keyboard Test" onKeyDown={handleKeyDown} />);
  ...
  it("can be disabled", () => {
    render(<GlassTextarea label="Disabled" disabled={true} />);
  ...
  it("handles required field", () => {
    render(<GlassTextarea label="Required" required={true} />);
  ...
  it("handles auto-resize settings", () => {
    ...
    rerender(
      <GlassTextarea label="Fixed Height" autoResize={false} minRows={5} />,
    );
  ...
  it("renders with different sizes", () => {
    const { rerender } = render(<GlassTextarea label="Small" size="sm" />);

    expect(screen.getByText("Small")).toHaveClass("text-sm");

    rerender(<GlassTextarea label="Large" size="lg" />);
