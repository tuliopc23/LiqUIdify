    ...
    it("should compose form components together", async () => {
      ...
      const FormExample = () => {
        ...
        return (
          ...
          >
            <GlassFormField label="Personal Information" variant="card">
              <input
                type="text"
                value={name}
      ...
      const ComplexForm = () => {
        ...
        return (
          <div>
            ...
            <div data-testid="form-state">{JSON.stringify(formData)}</div>
          </div>
        );
      };
