...
export type ProgressLinearVariantProps = {
  [key in keyof ProgressLinearVariant]?: ConditionalValue<ProgressLinearVariant[key]> | undefined
}
...
export interface ProgressLinearRecipe {
  ...
  splitVariantProps<Props extends ProgressLinearVariantProps>(props: Props): [ProgressLinearVariantProps, Pretty<DistributiveOmit<Props, keyof ProgressLinearVariantProps>>]
  getVariantProps: (props?: ProgressLinearVariantProps) => ProgressLinearVariantProps
}
