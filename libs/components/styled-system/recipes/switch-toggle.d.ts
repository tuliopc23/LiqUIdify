...
export type SwitchToggleVariantProps = {
  [key in keyof SwitchToggleVariant]?: ConditionalValue<SwitchToggleVariant[key]> | undefined
}
...
export interface SwitchToggleRecipe {
  ...
  splitVariantProps<Props extends SwitchToggleVariantProps>(props: Props): [SwitchToggleVariantProps, Pretty<DistributiveOmit<Props, keyof SwitchToggleVariantProps>>]
  getVariantProps: (props?: SwitchToggleVariantProps) => SwitchToggleVariantProps
}
