...
export type SymbolTileVariantProps = {
  [key in keyof SymbolTileVariant]?: ConditionalValue<SymbolTileVariant[key]> | undefined
}
...
export interface SymbolTileRecipe {
  ...
  splitVariantProps<Props extends SymbolTileVariantProps>(props: Props): [SymbolTileVariantProps, Pretty<DistributiveOmit<Props, keyof SymbolTileVariantProps>>]
