...
import { GlassAccordion, GlassAccordionItem, GlassAccordionTrigger, GlassAccordionContent, Accordion } from './glass-accordion';
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible accordion component with glassmorphism design, smooth animations, and support for single or multiple expanded items.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    type: {
      ...
      description: 'Type of accordion - single allows only one item open at a time, multiple allows multiple items open',
    },
    size: {
      control: 'select',
      options: ['sm', 'md', 'lg'],
      ...
      <GlassAccordion {...args}>
        <GlassAccordionItem value="item-1">
          ...
          <GlassAccordionContent>
            Glassmorphism is a design trend that uses transparency, blur effects, and subtle borders to create a glass-like appearance. It provides depth and hierarchy while maintaining visual lightness.
          </GlassAccordionContent>
        </GlassAccordionItem>
        <GlassAccordionItem value="item-2">
          <GlassAccordionTrigger>How do I use this component?</GlassAccordionTrigger>
          <GlassAccordionContent>
            Import the component and use it like any other React component. You can control which items are expanded, customize the appearance with variants, and add your own content.
          </GlassAccordionContent>
        </GlassAccordionItem>
        <GlassAccordionItem value="item-3">
          <GlassAccordionTrigger>Is it accessible?</GlassAccordionTrigger>
          <GlassAccordionContent>
            Yes! This component is built on Radix UI primitives, providing full keyboard navigation, ARIA attributes, and screen reader support out of the box.
          </GlassAccordionContent>
        </GlassAccordionItem>
      </GlassAccordion>
    </div>
    ...
    <div className="w-[600px]">
      <GlassAccordion {...args}>
        ...
        <GlassAccordionItem value="item-2">
          ...
          <GlassAccordionContent>
            Built with Radix UI for robust accessibility and behavior. Uses Framer Motion for smooth animations and Tailwind CSS for styling.
          </GlassAccordionContent>
        </GlassAccordionItem>
        <GlassAccordionItem value="item-3">
          <GlassAccordionTrigger>Browser Support</GlassAccordionTrigger>
          <GlassAccordionContent>
            Works in all modern browsers that support CSS backdrop-filter. Gracefully degrades in older browsers.
          </GlassAccordionContent>
        </GlassAccordionItem>
      </GlassAccordion>
    </div>
...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-8 w-[600px]">
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Small</h3>
      ...
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Medium (Default)</h3>
      ...
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Large</h3>
...
export const Variants: Story = {
  render: () => (
    <div className="space-y-8 w-[600px]">
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Default</h3>
      ...
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Solid</h3>
      ...
      <div>
        <h3 className="text-sm font-semibold mb-2 text-white/80">Ghost</h3>
    ...
    <div className="w-[600px]">
      <GlassAccordion type="single" collapsible defaultValue="item-1">
        <GlassAccordionItem value="item-1">
          ...
          <GlassAccordionContent>
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-white mb-2">Props</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between py-1">
                    ...
                    <span className="text-white/60">"default" | "solid" | "ghost"</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <GlassAccordionItem value="item-2">
          ...
          <GlassAccordionContent>
            <pre className="bg-black/20 p-3 rounded-lg text-sm overflow-x-auto">
    ...
    <div className="w-[600px]">
      <Accordion type="single" collapsible>
        ...
        <Accordion.Item value="item-2">
          ...
          <Accordion.Content>
            This pattern groups related components together and makes the relationship between them clearer.
          </Accordion.Content>
        </Accordion.Item>
      </Accordion>
    </div>
