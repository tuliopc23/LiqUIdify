...
const accordionVariants = cva(
	"w-full space-y-2 backdrop-blur-md rounded-lg bg-white/5 border border-white/10 p-2",
	{
		variants: {
			size: {
				sm: "text-sm p-1",
...
const accordionItemVariants = cva(
	"backdrop-blur-sm rounded-lg border border-white/10 bg-white/5 overflow-hidden transition-all duration-200 hover:bg-white/10",
	{
		variants: {
			size: {
				sm: "text-sm",
...
const accordionTriggerVariants = cva(
	"flex flex-1 items-center justify-between w-full p-4 font-medium text-left transition-all duration-200 hover:bg-white/5 focus:bg-white/10 focus:outline-none group text-white data-[state=open]:bg-white/5",
	{
		variants: {
			size: {
				sm: "p-2 text-sm",
