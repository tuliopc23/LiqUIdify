    ...
    <div className="min-h-screen p-8 space-y-8">
      <div className="text-center mb-12">
        ...
        <p className="text-white/80 text-lg">
          Based on Apple's 2025 design system with depth, micro-interactions, and liquid animations
        </p>
      </div>

      {/* Depth Showcase */}
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">Glass Depth Layers</h2>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">Interactive Effects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="apple-glass apple-glass--depth-2 apple-glass--magnetic p-6 text-center">
            ...
            <p className="text-white/70 text-sm">Hover for magnetic lift effect</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="apple-glass apple-glass--depth-3 apple-glass--magnetic p-6">
            ...
            <p className="text-white/80 text-sm mb-4">
              This card demonstrates the authentic Apple liquid glass effect with depth, luminosity, and interactive animations.
            </p>
            <div className="flex gap-2">
              <span className="apple-glass apple-glass--depth-1 px-2 py-1 text-xs text-white rounded">New</span>
              <span className="apple-glass apple-glass--depth-1 px-2 py-1 text-xs text-white rounded">Featured</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Navigation Examples */}
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">Navigation Components</h2>
        <div className="apple-glass apple-glass--depth-2 p-4 rounded-2xl">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <a href="#" className="apple-glass apple-glass--depth-1 apple-glass--shimmer px-3 py-2 text-white rounded-lg hover:no-underline">Home</a>
              <a href="#" className="apple-glass apple-glass--depth-1 apple-glass--shimmer px-3 py-2 text-white rounded-lg hover:no-underline">About</a>
              <a href="#" className="apple-glass apple-glass--depth-1 apple-glass--shimmer px-3 py-2 text-white rounded-lg hover:no-underline">Contact</a>
            </div>
      ...
      <div className="text-center mt-12">
        <p className="text-white/60 text-sm">
          Authentic Apple liquid glass effects with depth layers, micro-interactions, and liquid animations
        </p>
      </div>
    </div>
  );
