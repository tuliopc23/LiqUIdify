...
const meta: Meta<typeof GlassFeatureShowcase> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile feature showcase component with glass morphism effects, supporting grid, masonry, and stacked layouts with various visual styles.',
      },
    },
  },
  tags: ['autodocs'],
...
export const GridCards: Story = {
  args: {
    ...
    subtitle: "Features",
    description: "Discover the powerful features that make Glass UI the perfect choice for modern applications.",
...
const singleColumnFeatures = [
  {
    ...
    title: "Launch Ready",
    description: "Production-ready components with comprehensive testing and documentation. Build faster with pre-configured themes and accessibility features.",
  ...
  },
  {
    ...
    description: "Bank-grade security with SOC 2 compliance, end-to-end encryption, and advanced threat protection. Trusted by Fortune 500 companies.",
    badge: "SOC 2",
...
export const SingleColumn: Story = {
  args: {
    ...
    description: "Scalable solutions designed for enterprise-grade applications with the highest standards of security and performance.",
