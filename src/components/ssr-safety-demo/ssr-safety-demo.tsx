	...
	return (
		...
		<HydrationSafe componentName="ProgressiveEnhancementDemo">
			...
			<div className="demo-section">
				...
				<p>
					Animations: {enhancements.animations ? "Supported" : "Not Supported"}
				</p>
				...
				<p>
					...
					{enhancements.intersectionObserver ? "Supported" : "Not Supported"}
				</p>

				<p>
					Resize Observer:{" "}
					{enhancements.resizeObserver ? "Supported" : "Not Supported"}
				</p>
			</div>
		</HydrationSafe>
	);
