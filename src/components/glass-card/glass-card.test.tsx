...
describe('GlassCard', () => {
  ...
  it('applies padding classes correctly', () => {
    render(
      <GlassCard padding="lg" data-testid="padded-card">
        Large padding
      </GlassCard>
    );
  ...
  it('removes border when bordered is false', () => {
    render(
      <GlassCard bordered={false} data-testid="no-border-card">
        No border
      </GlassCard>
    );
...
describe('GlassCard sub-components', () => {
  ...
  it('renders GlassCardContent correctly', () => {
    render(
      <GlassCardContent data-testid="card-content">Content</GlassCardContent>
    );
