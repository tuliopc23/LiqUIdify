...
const GlassResponsiveCard = forwardRef(({ className, variant = "default", hover = true, bordered = true, padding = "md", responsive = true, stackOnMobile = false, children, ...props }, ref) => {
    ...
    const baseClasses = cn("rounded-xl overflow-hidden", variantClasses[variant], paddingClasses[padding], bordered && variant !== "outlined" && "border border-[var(--glass-border)]", hover && "glass-interactive cursor-pointer", microInteraction.smooth, "will-change-transform", 
