    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        <section className="border p-6 rounded-lg">
          ...
          <p className="text-gray-600 mb-4">
            Click the button or press Tab and Enter to open the modal. 
            Press Escape or Enter on the backdrop to close.
          </p>
          <button
        ...
        <section className="border p-6 rounded-lg">
          ...
          <p className="text-gray-600 mb-4">
            Notifications should be keyboard accessible. Tab to focus and press Enter or Space.
          </p>
          <NotificationCenter
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg">
        ...
        <ul className="list-disc list-inside space-y-1 text-sm">
          ...
          <li>Press Enter or Space to activate buttons and clickable elements</li>
