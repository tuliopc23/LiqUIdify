...
export class AccessibilityChecker {
    ...
    checkElement(element, componentName) {
        this.issues = [];
...
export function runAccessibilityCheck(element, componentName) {
    const checker = new AccessibilityChecker();
    return checker.checkElement(element, componentName);
}
// Helper to assert accessibility in tests
export function expectAccessible(element, componentName, minScore = 80) {
