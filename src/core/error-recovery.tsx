...
export function usePerformance() {
    const [performanceObj, setPerformanceObj] = useState<Performance | null>(null);
...
export function useClearTimeout() {
    ...
    useEffect(() => {
        setClearTimeoutFn(typeof clearTimeout !== 'undefined' ? clearTimeout : null);
    }, []);
...
export function useClearInterval() {
    ...
    useEffect(() => {
        setClearIntervalFn(typeof clearInterval !== 'undefined' ? clearInterval : null);
    }, []);
...
export function useURLSearchParams() {
    const [urlSearchParamsObj, setUrlSearchParamsObj] = useState<typeof URLSearchParams | null>(null);

    useEffect(() => {
        setUrlSearchParamsObj(typeof URLSearchParams !== 'undefined' ? URLSearchParams : null);
    }, []);
...
export function useWebSocket() {
    const [webSocketObj, setWebSocketObj] = useState<typeof WebSocket | null>(null);
...
export function useSharedWorker() {
    const [sharedWorkerObj, setSharedWorkerObj] = useState<typeof SharedWorker | null>(null);

    useEffect(() => {
        setSharedWorkerObj(typeof SharedWorker !== 'undefined' ? SharedWorker : null);
    }, []);
...
export function useMessageChannel() {
    const [messageChannelObj, setMessageChannelObj] = useState<typeof MessageChannel | null>(null);

    useEffect(() => {
        setMessageChannelObj(typeof MessageChannel !== 'undefined' ? MessageChannel : null);
    }, []);
...
export function useBroadcastChannel() {
    const [broadcastChannelObj, setBroadcastChannelObj] = useState<typeof BroadcastChannel | null>(null);

    useEffect(() => {
        setBroadcastChannelObj(typeof BroadcastChannel !== 'undefined' ? BroadcastChannel : null);
    }, []);
...
export function useCustomEvent() {
    const [customEventObj, setCustomEventObj] = useState<typeof CustomEvent | null>(null);
...
export function useEventTarget() {
    const [eventTargetObj, setEventTargetObj] = useState<typeof EventTarget | null>(null);
...
export function useTypeError() {
    const [typeErrorObj, setTypeErrorObj] = useState<typeof TypeError | null>(null);
...
export function useRangeError() {
    const [rangeErrorObj, setRangeErrorObj] = useState<typeof RangeError | null>(null);
...
export function useReferenceError() {
    const [referenceErrorObj, setReferenceErrorObj] = useState<typeof ReferenceError | null>(null);

    useEffect(() => {
        setReferenceErrorObj(typeof ReferenceError !== 'undefined' ? ReferenceError : null);
    }, []);
...
export function useSyntaxError() {
    const [syntaxErrorObj, setSyntaxErrorObj] = useState<typeof SyntaxError | null>(null);
...
export function useEvalError() {
    const [evalErrorObj, setEvalErrorObj] = useState<typeof EvalError | null>(null);
...
export function useAggregateError() {
    const [aggregateErrorObj, setAggregateErrorObj] = useState<typeof AggregateError | null>(null);

    useEffect(() => {
        setAggregateErrorObj(typeof AggregateError !== 'undefined' ? AggregateError : null);
    }, []);
...
export function useInternalError() {
    const [internalErrorObj, setInternalErrorObj] = useState<typeof InternalError | null>(null);

    useEffect(() => {
        setInternalErrorObj(typeof InternalError !== 'undefined' ? InternalError : null);
    }, []);
