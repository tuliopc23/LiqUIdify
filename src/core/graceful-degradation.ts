        ...
        useEffect(() => {
            const checkPerformance = () => {
                ...
                if ('connection' in navigator) {
                    ...
                    if (connection) {
                        const effectiveType = connection.effectiveType;
                        score += effectiveType === '4g' ? 3 : effectiveType === '3g' ? 2 : 1;
                    }
                }
    ...
    return function AccessibilityFallbackWrapper() {
        ...
        useEffect(() => {
            const checkAccessibilityPreferences = () => {
                ...
                setUseAccessibleVersion(prefersReducedMotion || prefersHighContrast || hasScreenReader);
            };
...
export const gracefulDegradation = {
    ...
    utils: {
        ...
        getAccessibilityPreferences: () => ({
            ...
            reducedData: typeof window !== 'undefined' &&
