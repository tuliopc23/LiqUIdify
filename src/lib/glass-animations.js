...
export const GLASS_EASINGS = {
    ...
    spring: (tension = 0.5, friction = 0.3) => `cubic-bezier(${tension}, ${friction}, 0.35, 1)`,
...
export class GlassGestureAnimator {
    constructor(element) {
        ...
        Object.defineProperty(this, "gestureHandlers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
