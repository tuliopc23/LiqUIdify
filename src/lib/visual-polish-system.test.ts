...
describe('Visual Polish System', () => {
    ...
    describe('VisualPolishManager', () => {
        ...
        describe('Micro-Interactions', () => {
            it('should add micro-interaction with preset', () => {
                polishManager.addMicroInteraction('test-hover', mockElement, 'subtleHover');
            ...
            it('should add micro-interaction with custom configuration', () => {
                ...
                polishManager.addMicroInteraction('test-custom', mockElement, customInteraction);
            ...
            it('should handle different trigger types', () => {
                ...
                triggers.forEach((preset, index) => {
                    polishManager.addMicroInteraction(`test-${index}`, mockElement, preset);
                });

                // Should have set up event listeners for each trigger type
                expect(mockElement.addEventListener).toHaveBeenCalledTimes(triggers.length * 2); // Each trigger has enter/leave or similar
            });
            ...
            it('should trigger haptic feedback when enabled', () => {
                ...
                manager.addMicroInteraction('test-haptic', mockElement, 'magneticHover');

                // Simulate interaction
                const handlers = mockElement.addEventListener.mock.calls;
                const mouseEnterHandler = handlers.find(call => call[0] === 'mouseenter')?.[1];
            ...
            it('should skip micro-interactions when disabled', () => {
                ...
                const manager = new VisualPolishManager(config);
                manager.addMicroInteraction('test-disabled', mockElement, 'subtleHover');
        ...
        describe('Visual Regression Testing', () => {
            it('should add visual regression test', () => {
                polishManager.addVisualRegressionTest('test-regression', 'Test Component', mockElement);
            ...
            it('should run visual regression test', async () => {
                ...
                const result = await polishManager.runVisualRegressionTest('test-regression');
            ...
            it('should handle missing baseline gracefully', async () => {
                const result = await polishManager.runVisualRegressionTest('non-existent-test');
        ...
        describe('Cross-Browser Testing', () => {
            it('should add cross-browser test', () => {
                polishManager.addCrossBrowserTest('test-browser', 'backdrop-filter', 'blur(20px)');
            ...
            it('should run cross-browser test', () => {
                ...
                const result = polishManager.runCrossBrowserTest('test-browser', mockElement);
            ...
            it('should handle non-existent test gracefully', () => {
                const result = polishManager.runCrossBrowserTest('non-existent', mockElement);
                expect(result).toBe(false);
            });
        ...
        describe('Quality Metrics', () => {
            ...
            it('should update overall score based on individual metrics', () => {
                ...
                const expectedOverallScore = individualScores.reduce((a, b) => a + b, 0) / individualScores.length;
    ...
    describe('useVisualPolish Hook', () => {
        ...
        it('should provide visual regression testing methods', async () => {
            ...
            act(() => {
                result.current.addVisualRegressionTest('test', 'Test Component', mockElement);
            });
        ...
        it('should provide cross-browser testing methods', () => {
            ...
            act(() => {
                result.current.addCrossBrowserTest('test', 'backdrop-filter', 'blur(20px)');
            });
    ...
    describe('Micro-Interaction Presets', () => {
        ...
        it('should have valid preset configurations', () => {
            Object.entries(MICRO_INTERACTION_PRESETS).forEach(([name, preset]) => {
    ...
    describe('Error Handling', () => {
        ...
        it('should handle invalid preset names gracefully', () => {
            ...
            expect(() => {
                polishManager.addMicroInteraction('test', mockElement, 'invalid-preset' as any);
            }).not.toThrow();
        ...
        it('should handle animation failures gracefully', () => {
            ...
            expect(() => {
                polishManager.addMicroInteraction('test', failingElement, 'subtleHover');
            }).not.toThrow();
