...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    const themeProperties = {
      ...
      '--glass-bg-secondary': theme === 'dark' ? 'rgba(44, 44, 46, 0.18)' : 'rgba(248, 250, 252, 0.15)',
      '--glass-bg-tertiary': theme === 'dark' ? 'rgba(58, 58, 60, 0.22)' : 'rgba(241, 245, 249, 0.18)',
      '--glass-bg-elevated': theme === 'dark' ? 'rgba(88, 88, 90, 0.28)' : 'rgba(255, 255, 255, 0.25)',
      '--glass-bg-floating': theme === 'dark' ? 'rgba(68, 68, 70, 0.25)' : 'rgba(255, 255, 255, 0.20)',
      '--glass-bg-overlay': theme === 'dark' ? 'rgba(48, 48, 50, 0.35)' : 'rgba(255, 255, 255, 0.30)',
      
      // Interactive states
      '--glass-bg-hover': theme === 'dark' ? 'rgba(78, 78, 80, 0.22)' : 'rgba(255, 255, 255, 0.18)',
      '--glass-bg-active': theme === 'dark' ? 'rgba(38, 38, 40, 0.18)' : 'rgba(255, 255, 255, 0.08)',
      '--glass-bg-focus': theme === 'dark' ? 'rgba(88, 88, 90, 0.25)' : 'rgba(255, 255, 255, 0.22)',
      '--glass-bg-pressed': theme === 'dark' ? 'rgba(28, 28, 30, 0.15)' : 'rgba(255, 255, 255, 0.06)',
      
      // Border colors
      '--glass-border-subtle': theme === 'dark' ? 'rgba(255, 255, 255, 0.05)' : 'rgba(255, 255, 255, 0.08)',
      '--glass-border-light': theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(255, 255, 255, 0.15)',
      '--glass-border-medium': theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(255, 255, 255, 0.25)',
      '--glass-border-strong': theme === 'dark' ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.35)',
      '--glass-border-focus': theme === 'dark' ? 'rgba(64, 156, 255, 0.4)' : 'rgba(59, 130, 246, 0.4)',
      '--glass-border-hover': theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(255, 255, 255, 0.3)',
      
      // Primary colors
      '--glass-primary': theme === 'dark' ? 'rgba(64, 156, 255, 0.8)' : 'rgba(59, 130, 246, 0.8)',
      '--glass-primary-hover': theme === 'dark' ? 'rgba(64, 156, 255, 0.9)' : 'rgba(59, 130, 246, 0.9)',
      '--glass-primary-active': theme === 'dark' ? 'rgba(64, 156, 255, 0.7)' : 'rgba(59, 130, 246, 0.7)',
      
      // Text colors
      '--text-primary': theme === 'dark' ? 'rgba(255, 255, 255, 0.95)' : 'rgba(0, 0, 0, 0.9)',
      '--text-secondary': theme === 'dark' ? 'rgba(255, 255, 255, 0.6)' : 'rgba(0, 0, 0, 0.6)',
      '--text-tertiary': theme === 'dark' ? 'rgba(255, 255, 255, 0.4)' : 'rgba(0, 0, 0, 0.4)',
