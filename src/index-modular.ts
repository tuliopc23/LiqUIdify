...
export const loadAnimations = () => import("./bundles/animations");
export const loadAdvanced = () => import("./bundles/advanced");
...
const componentMap = {
	GlassModal: () =>
		import("./components/glass-modal").then((m) => m.GlassModal),
	GlassTooltip: () =>
		import("./components/glass-tooltip").then((m) => m.GlassTooltip),
	GlassDropdown: () =>
		import("./components/glass-dropdown").then((m) => m.GlassDropdown),
	GlassAccordion: () =>
		import("./components/glass-accordion").then((m) => m.GlassAccordion),
	...
	DonutChart: () =>
		import("./components/glass-chart").then((m) => m.DonutChart),
	CommandPalette: () =>
		import("./components/glass-command").then((m) => m.CommandPalette),
} as const;
