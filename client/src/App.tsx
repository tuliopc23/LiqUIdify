    ...
    <div className="min-h-screen bg-liquid-bg">
      <header className="bg-liquid-bg shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-liquid-secondary">
            HackerFolio
          </h1>
          <p className="mt-2 text-liquid-secondary">
            Showcasing projects with proper API case mapping
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <h2 className="text-2xl font-semibold text-liquid-secondary mb-6">
            Projects
          </h2>
          {projects.length === 0 ? (
