    ...
    extend: {
      tokens: {
        ...
        shadows: {
          ...
          hairline: { value: '0 0 0 1px color-mix(in oklch, var(--colors-gray-700) 75%, transparent)' },
          sm: { value: '0 4px 18px rgba(0,0,0,.18)' }
        },
        fonts: {
          sans: {
            value: '-apple-system, system-ui, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Apple Color Emoji", "Segoe UI Emoji"'
          },
      ...
      semanticTokens: {
        colors: {
          ...
          'bg.surface': { value: { base: '{colors.gray.100}', _dark: '{colors.gray.800}' } },
          'bg.subtle': { value: { base: '#F2F3F5', _dark: '#0F1012' } },
          // Borders / hairlines
          'border.default': { value: { base: '{colors.gray.200}', _dark: '{colors.gray.700}' } },
          'border.hairline': { value: { base: 'color-mix(in oklch, #000 10%, transparent)', _dark: 'color-mix(in oklch, #fff 8%, transparent)' } },
          // Accents
          primary: { value: { base: '{colors.blue.500}', _dark: '{colors.blue.500}' } },
          success: { value: { base: '{colors.green.500}', _dark: '{colors.green.500}' } },
          info: { value: { base: '{colors.indigo.500}', _dark: '{colors.indigo.500}' } },
          warn: { value: { base: '{colors.orange.500}', _dark: '{colors.orange.500}' } },
          danger: { value: { base: '{colors.pink.500}', _dark: '{colors.pink.500}' } },
          // Glass tokens
          'glass.bg': { value: { base: 'color-mix(in oklch, #ffffff 70%, transparent)', _dark: 'color-mix(in oklch, #000000 55%, transparent)' } },
          'glass.border': { value: { base: 'color-mix(in oklch, #000 12%, transparent)', _dark: 'color-mix(in oklch, #fff 12%, transparent)' } },
          'glass.highlight': { value: { base: 'linear-gradient(180deg, rgba(255,255,255,.14), transparent)', _dark: 'linear-gradient(180deg, rgba(255,255,255,.08), transparent)' } }
        }
      },
