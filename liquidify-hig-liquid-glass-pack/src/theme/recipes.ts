...
export const button = defineRecipe({
	...
	base: {
		...
		transition:
			"background-color .15s ease, transform .05s ease, border-color .15s ease",
		_focusVisible: {
			outline: "none",
	...
	variants: {
		intent: {
			primary: {
				...
				_hover: {
					backgroundColor:
						"color-mix(in oklch, var(--colors-primary) 92%, black 8%)",
				},
			},
			neutral: {
				color: "text",
				...
				_hover: {
					backgroundColor:
						"color-mix(in oklch, var(--colors-bg-surface) 92%, black 8%)",
				},
			},
			glass: {
				color: "text",
				...
				_hover: {
					backgroundColor:
						"color-mix(in oklch, var(--colors-glass-bg) 100%, transparent)",
				},
			},
			link: {
				color: "primary",
